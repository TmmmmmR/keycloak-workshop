...
@WebMvcTest(value = ApisController.class)
 ...
 * <p>his class use {@link SecurityConfiguration.CommonSpringKeycloakTutorialsSecuritAdapter} which define all
 * security matchers</p>
 */
@TestConfiguration
@EnableWebSecurity
 class SecurityTestConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.apply(new SecurityConfiguration.CommonSpringKeycloakTutorialsSecuritAdapter());
