...
public class PhotoRepresentation {
    ...
    public PhotoRepresentation(String id, String name, String base64Img, String externalId, OwnerRepresentation owner) {
        this.id = id;
        this.name = name;
    ...
    private String base64Img; // May be null when we're sending list of the photoz
    ...
    public boolean isHasViewDetailsScope() {
        return hasScope(PhotozAuthzService.SCOPE_VIEW_DETAIL);
    }

    public boolean isHasDeleteScope() {
        return hasScope(PhotozAuthzService.SCOPE_DELETE);
    }
}
